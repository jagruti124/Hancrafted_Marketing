...
<br>
    ...
    <section class="categories" id="categories">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <img src="Toyshine-Branding-Final_01-scaled.jpg" alt="">
                <!-- <h3>Clay pots</h3>
                <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
