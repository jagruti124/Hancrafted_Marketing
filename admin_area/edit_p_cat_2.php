...
$edit_p_cat_query = "select * from warehouse_categories where p_cat_id='$edit_p_cat_id'";
...
$update_p_cat = "update warehouse_categories set p_cat_title='$p_cat_title',p_cat_top='$p_cat_top',p_cat_image='$p_cat_image' where p_cat_id='$p_cat_id'";
