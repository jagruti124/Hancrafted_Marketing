...
<input type="submit" name="submit" value="Insert Warehouse" class="btn btn-primary form-control" >
...
echo "<script>alert('Warehouse has been inserted successfully')</script>";
