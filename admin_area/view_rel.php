...
// $get_rel = "select * from bundle_warehouse_relation";
...
// $warehouse_id = $row_rel['warehouse_id'];

// $get_p = "select * from warehouses where warehouse_id='$warehouse_id'";
...
// $get_b = "select * from warehouses where warehouse_id='$bundle_id'";
