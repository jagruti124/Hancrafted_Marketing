...
// $edit_rel = "select * from bundle_warehouse_relation where rel_id='$edit_id'";
...
// $r_p = $row_edit['warehouse_id'];

// $r_b = $row_edit['bundle_id'];

// $get_p = "select * from warehouses where warehouse_id='$r_p'";
...
// $get_b = "select * from warehouses where warehouse_id='$r_b'";

// $run_b = mysqli_query($con,$get_b);

// $row_b = mysqli_fetch_array($run_b);

// $b_id = $row_b['warehouse_id'];

// $b_title = $row_b['warehouse_title'];
...
// $update_rel = "update bundle_warehouse_relation set rel_title='$rel_title',warehouse_id='$warehouse_id',bundle_id='$bundle_id' where rel_id='$r_id'";
