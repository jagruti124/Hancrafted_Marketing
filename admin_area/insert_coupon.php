...
$get_coupons = "select * from coupons where warehouse_id='$warehouse_id' or coupon_code='$coupon_code'";
...
$insert_coupon = "insert into coupons (warehouse_id,coupon_title,coupon_price,coupon_code,coupon_limit,coupon_used) values ('$warehouse_id','$coupon_title','$coupon_price','$coupon_code','$coupon_limit','$coupon_used')";
